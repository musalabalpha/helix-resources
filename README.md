...
- [`produccion-de-entregables/`](skills/produccion-de-entregables/) — cuando piden una propuesta, un plan, una maqueta o un prompt para otro agente: elige carril (rápido, normal o visual), alinea la forma antes de construir con 3 opciones y 5 puntos, pasa por un revisor si quien recibe no puede repreguntar, y entrega con una ruta probada y un "¿se ejecutó?" a los 7 días. Incluye plantillas y un catálogo de marcos por dominio.
